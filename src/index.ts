 ...
 */
export function map <T extends object> (schema: SchemaObject, input: any): T | undefined
export function map <T extends any[]> (schema: SchemaArray, input: any): T | undefined
export function map <T extends any> (schema: Schema, input: any): T | undefined
export function map <T extends any> (schema: Schema, input: any): T | undefined {
